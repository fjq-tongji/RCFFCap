...
def main(params):
  ...
  #with open(params['output_pkl']+'-words.p','w') as f:
...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='data/coco/dataset_coco_retrieval_res101_new_trainvaltest.json', help='input json file to process into hdf5')
  parser.add_argument('--dict_json', default='data/coco/cocotalk_clip_res101.json', help='output json file')
