...
def eval_split(model, crit, loader, eval_kwargs={}):
    ...
    while True:
        ...
        with torch.no_grad():
            ...
            seq = final[0].data
            attn_e = final[-1].data  ### keshihua_encoder
            attn_d = final[-2].data  ### keshihua_decoder
            #print(seq.shape)
            #print(attn.shape)
        #print(seq.shape)
        #print(attn.shape)
        ...
        for k, sent in enumerate(sents):
            ...
            if verbose:
                ...
                #np.save(os.path.join('/home/fjq/husthuaan/log/attn_encoder/attn/' + str(entry['image_id']) + '-attn'), attn[0][0].cpu().numpy())
