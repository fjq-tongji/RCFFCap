...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_json', default=r'data/coco/cocotalk.json',
                        help='output json file')
    parser.add_argument('--output_h5', default=r'data/coco/cocotalk_label.h5',
                        help='output h5 file')
    ...
    parser.add_argument('--images_root',
                        default=r'../../bottom-up-attention/images',
