...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_h5', default=r'data/cityscapes/2. city_new_traffic_sign/cityscapes_paragraph_trainval_traffic_sign_talk.h5',
                        help='output h5 file')
    parser.add_argument('--object_name', default='data/cityscapes/2. city_new_traffic_sign/cityscapes_object_name',
                        help='')
    parser.add_argument('--object_name_num', default='data/cityscapes/2. city_new_traffic_sign/cityscapes_object_name/num',
                       help='')
