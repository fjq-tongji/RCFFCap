...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default=r'data/cityscapes/2.city_new_traffic_sign/cityscapes_paragraph_trainval_traffic_sign.json',
                        help='input json file to process into hdf5')
    parser.add_argument('--num_val', default=0,  type=int,
                        help='number of images to assign to validation data (for CV etc)')
    parser.add_argument('--output_json', default=r'data/cityscapes/2.city_new_traffic_sign/cityscapes_paragraph_trainval_traffic_sign_talk.json',
                        help='output json file')
    parser.add_argument('--output_h5', default=r'data/cityscapes/2.city_new_traffic_sign/cityscapes_paragraph_trainval_traffic_sign_talk.h5',
                        help='output h5 file')
    parser.add_argument('--object_name', default='data/cityscapes/2.city_new_traffic_sign/cityscapes_object_name_filter',
                        help='')
    parser.add_argument('--object_name_num', default='data/cityscapes/2.city_new_traffic_sign/cityscapes_object_name_filter/num',
                       help='')
    parser.add_argument('--attr_name', default='data/cityscapes/2.city_new_traffic_sign/cityscapes_attr_name',
                        help='')
    parser.add_argument('--attr_name_num', default='data/cityscapes/2.city_new_traffic_sign/cityscapes_attr_name/num',
                        help='')
