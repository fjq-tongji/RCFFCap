### input_encoding_size = att_hid_size == 1024
...
def parse_opt():
    ...
    # Data input settings
    #parser.add_argument('--save_eval_results', type=str, default='data/eval_results/eval_results.json', help='path to save the results of val set')  
    ...
    #parser.add_argument('--input_cls_token', type=str, default='data/cocobu_att',
     #               help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_word_dir', type=str, default='data/cityscapes/cityscapes_object_name',
                    help='')
    parser.add_argument('--input_attr_dir', type=str, default='data/cityscapes/cityscapes_attr_name',
                    help='')
    parser.add_argument('--input_seg_dir', type=str, default='data/cityscapes/cityscapes_attr_name',
                        help='')
    ...
    parser.add_argument('--start_from', type=str, default='log/log_transformer_new_label_1_32',
    ...
    # Model settings
    parser.add_argument('--caption_model', type=str, default="m2trnasformer",
    ...
    parser.add_argument('--self_critical_after', type=int, default=-1,    ### -1
    ...
    parser.add_argument('--split', type=str, default='val',   ### train stage eval, do no change
...
def add_eval_options(parser):
    ...
    parser.add_argument('--input_att_dir', type=str, default='',
                    help='path to the h5file containing the preprocessed dataset')
    #parser.add_argument('--input_cls_token', type=str, default='',
     #               help='path to the h5file containing the preprocessed dataset')
    ...
    parser.add_argument('--split', type=str, default='test',   ### test stage , 
                    help='if running on MSCOCO images, which split to use: val|test|train')
