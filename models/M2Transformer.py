...
#from m2transformer.m2transformer.models.transformer import Transformer, MemoryAugmentedEncoder, MeshedDecoder, ScaledDotProductAttentionMemory
from .m2transformer.models.transformer.transformer import Transformer
from .m2transformer.models.transformer.encoders import MemoryAugmentedEncoder
from .m2transformer.models.transformer.decoders import MeshedDecoder
from .m2transformer.models.transformer.attention import ScaledDotProductAttentionMemory
...
class M2TransformerModel(TransformerModel):
    ...
    def _forward(self, fc_feats, att_feats, word_feats, attr_feats, seg_feats, boxes_feats, seq, att_masks=None):
