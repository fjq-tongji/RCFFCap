...
#########################################################################################################
        ...
        for t in range(self.seq_length + group_size - 1):
            for divm in range(group_size): 
                if t >= divm and t <= self.seq_length + divm - 1:
                    ...
                    logprobs_table[divm], state_table[divm], attn_t,attn_c = self.get_logprobs_state(it.cuda(), *(args[divm] + [state_table[divm]]))
                    #print(attn.shape)
        ...
        return done_beams, attn_t,attn_c
