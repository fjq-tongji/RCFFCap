...
class Encoder(nn.Module):
    ...
    def __init__(self, layer, N):
        ...
        #self.msa_0 = MultiHeadedAttention(8, 256)
        self.msa = MultiHeadedAttention(8, 512, 0.1)
        ...
        #self.linear1 = nn.Linear(512, 512 // 16)
        #self.relu = nn.ReLU()
        #self.linear2 = nn.Linear(512 // 16, 512)
    ...
    def forward(self, fc_feats, att, word_feats, attr_feats, seg_feats, boxes_feats, mask):     ## fc(5,512)
        ...
        #attr_word = self.linear2(self.relu(self.linear1(attr_word)))
