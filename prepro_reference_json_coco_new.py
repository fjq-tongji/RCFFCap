...
def main(params):
    ...
    imgs = json.load(open(params['input_json'], 'r'))  ## [0]
    # tmp = []
    # for k in imgs.keys():
    #     for img in imgs[k]:
    ...
    for i, img in enumerate(imgs):
        ...
        for j, s in enumerate(img['sentences'][:5]):
            if len(s) == 0:
                continue
            s = ' '.join(s['tokens'])
...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='/home/fjq/OpenAI-CLIP-Feature/dataset_coco_retrieval_res101_new_trainvaltest.json',
                        help='input json file to process into hdf5')
    parser.add_argument('--output_json', default='data/coco/dataset_coco_captions4eval_res101.json',
