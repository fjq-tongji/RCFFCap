...
os.environ["CUDA_LAUNCH_BLOCKING"] = "0,1,2,9"
os.environ["CUDA_VISIBLE_DEVICES"] = "0,1,2,9"
...
def train(opt):
    ...
    try:
        while True:
            ...
            model_out = dp_lw_model(fc_feats, att_feats, word_feats, attr_feats, seg_feats, boxes_feats, labels, masks, att_masks,
                                    data['gts'], torch.arange(0, len(data['gts'])), sc_flag)

            #print(parameter_count_table(dp_lw_model))
