...
npy_path_new = "/data2/fjq/1.next_paper/clip_retrieval_filter_new/coco_label_filter_results/new_json_0830/cocobu_label_filter_0.8_res101/"
            ...
            for j in file:
                if int(j["cocoid"]) == int(i[:-4]):
                    ...
                    for item_str in npy_:
                        for k in j['sentences']:   ##################### K captions
