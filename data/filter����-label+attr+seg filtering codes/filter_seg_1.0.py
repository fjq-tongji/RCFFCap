...
seg_new_npy_path = "/data2/fjq/1.next_paper/clip_retrieval_filter_new/coco_seg_filter_results/new_json_0830/cocobu_seg_filter_1.0_res101/"
            ...
            if int(j["cocoid"]) == int(i[:-4]):
                for item_str in seg_list:
                    for k in j['sentences']:
                        if item_str in k['tokens'] and (item_str not in object_list):
