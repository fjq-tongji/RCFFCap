...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default=r'cityscapes_paragraph_trainval.json',
                        help='input json file to process into hdf5')
    parser.add_argument('--num_val', default=0,  type=int,
                        help='number of images to assign to validation data (for CV etc)')
    parser.add_argument('--output_json', default=r'cityscapes_paragraph_trainval_talk---new.json',
                        help='output json file')
    parser.add_argument('--output_h5', default=r'cityscapes_paragraph_trainval_talk---new.h5',
                        help='output h5 file')
    parser.add_argument('--object_name', default='/data2/fjq/1.next_paper/Cityscapes-total/5.city_label_filter_0.4',
                        help='')
    parser.add_argument('--object_name_num', default='/data2/fjq/1.next_paper/Cityscapes-total/5.city_label_filter_0.4/num',
                       help='')

    parser.add_argument('--attr_name', default='/data2/fjq/1.next_paper/Cityscapes-total/6.city_attr_filter_1.0_new',
                        help='')
    parser.add_argument('--attr_name_num', default='/data2/fjq/1.next_paper/Cityscapes-total/6.city_attr_filter_1.0_new/num',
                        help='')

    parser.add_argument('--seg_name', default='cityscapes_seg_name',
                        help='')
    parser.add_argument('--seg_name_num', default='cityscapes_seg_name/num',
                        help='')
