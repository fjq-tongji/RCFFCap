  ...
  for img in imgs:
    ...
    if (params['split'] == img['split']) or \
      ...
      for sent in img['captions']:
        ...
        sent_list = sent.split(' ')  ##'I love china' -> ['I','love','china']
        tmp_tokens = sent_list + ['<eos>']
...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='data/cityscapes/2. city_new_traffic_sign/cityscapes_paragraph_trainval_traffic_sign.json', help='input json file to process into hdf5')
  parser.add_argument('--dict_json', default='data/cityscapes/2. city_new_traffic_sign/cityscapes_paragraph_trainval_traffic_sign_talk.json', help='output json file')
  parser.add_argument('--output_pkl', default='data/cityscapes/2. city_new_traffic_sign', help='output pickle file')
